                        ...
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            ...
                            @foreach($contents as $content)
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td>Initial</td>
                                    <td><a class="text-primary" href="{{url('admins/processing')}}/{{$content->reference_number}}"
                                           target="_blank">{{$content->reference_number}} <span
                                                class="counts">{{$content->count}}</span></a></td>
                                    <td>{{$content->country}}</td>
                                    <td>{{$content->email}}</td>
                                    <td>  <span class="text-success">Paid
                                      {{ \App\Http\Controllers\DataController::getPaymentType
